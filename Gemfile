...
# Error tracking + performance tracing [https://github.com/getsentry/sentry-ruby]
gem "sentry-ruby"
gem "sentry-rails"
gem "stackprof"
...
group :test do
  # Browser-level system tests [https://guides.rubyonrails.org/testing.html#system-testing]
  gem "capybara"
